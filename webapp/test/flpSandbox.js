		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#tra0304epm04-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"tra0304epm04-display": {
								"semanticObject": "tra0304epm04",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tra0304.epm04",
									"url": sap.ui.require.toUrl("tra0304/epm04")
								}
							}
						}
					}
